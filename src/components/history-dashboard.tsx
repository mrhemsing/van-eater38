                          ...
                          <div>
                            <p className="text-lg font-medium uppercase text-neutral-100 md:text-xl">
                              ...
                              {ubereatsLinks[restaurant.slug as keyof typeof ubereatsLinks] ? (
                                <span className="ml-[8px] inline-flex -translate-y-[1px] items-center align-middle md:ml-[11px] md:-translate-y-[1px]" title="Uber Eats available">
                                  <img src="/images/uber-eats-logo-black.svg" alt="Uber Eats available" className="h-[22px] w-[22px] rounded-[4px] md:h-[55px] md:w-[55px]" />
                                </span>
                              ) : null}{' '}
